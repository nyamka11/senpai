...
class AdvertisementFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'adsBody' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'adsBody' => 'Lorem ipsum dolor sit amet',
                'photo' => 'Lorem ipsum dolor sit amet',
                'createDate' => '2020-11-25 10:25:14',
            ],
        ];
        parent::init();
    }
