...
<body class=" page-register">
    <div class="split-bg bg-twothirds-teal6 with-header overflow-initial">
        <div class="container full-height bg-teal-6-sm">
                ...
                <div class="col-sm-8 pad-right full-height">
                    <section class="section section-noleft">
                        <div class="section-content">
                            ...
                            <form method="POST" action="https://app.getmaple.ca/register" class="js-reg-form">
                                        ...
                                        <section>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input data-e2e="first_name" class="form-control" required
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input data-e2e="last_name" class="form-control" required
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="email" id="email" value=""
                                                            class="form-control" required data-e2e="email"
                                                            placeholder="mongolsenpai@gmail.com">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group primary-password">
                                                        <label class="control-label" style="width: 100%;">
                                                            Create password <a data-toggle="modal" data-target="#pass"
                                                                class="underlink" href="#"
                                                                style="float: right; margin-right: 30px;">
                                                                Why do I need a strong password? </a>
                                                        </label>
                                                        <div style="position:relative">
                                                            <input type="password" name="password" value=""
                                                                id="password" class="form-control js-password-strength"
                                                                data-e2e="password" data-is-strong-password="1"
                                                                required>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="birthday_at" class="control-label">Date of
                                                            birth</label>
                                                        <input data-e2e="birthday_at" class="form-control js-dob-mask"
                                                            im-insert="false" name="birthday_at" type="text"
                                                            id="birthday_at">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select data-e2e="province"
                                                            class="form-control js-reg-province-select" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="radio" style="margin-bottom: 0">
                                                            <label style="margin-right: 15px"><input type="radio"
                                                                    ...
                                                                    data-e2e="phone_type_mobile" checked>
                                                                Mobile</label>
                                                            <label data-trigger="hover" data-container="body"
                                                                data-placement="auto" data-toggle="popover"
                                                                title="We recommend you use a mobile phone."
                                    ...
                                    <div id="credit_code" class="collapse">
                                        <div style="padding: 10px 0">
                                            <div class="form-group" id="check_credit_code_wrapper">
                                                <input data-reg="true" type="text" name="credit_code"
                                                    id="check_credit_code" class="form-control"
                                                    placeholder="Enter promo code here" value="" />
                                                <div class="text-right" id="credit_code_result"
                                                    style="height: 40px; padding-top: 10px"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-section">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block btn-lg text-serif "
                                                data-heap="register-submit-button" data-e2e="submit">Create your
                                                account</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <p class="hide-for-step1">
                            <small>By creating an account, you certify you are at least 16 years of age, and agree to
                                SENPAI Team’s <a data-toggle="modal" data-target="#terms" class="underlink"
                                    href="#">Terms of Use</a>.</small>
                        </p>
                        <!-- Modal -->
